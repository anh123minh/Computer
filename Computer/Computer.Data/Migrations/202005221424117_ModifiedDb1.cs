namespace Computer.Data.Migrations
{
    ...
    public partial class ModifiedDb1 : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.ComputerUsingHistories", "UserId", "dbo.ApplicationUsers", "Id", cascadeDelete: true);
        }
        
        public override void Down()
        {
            DropForeignKey("dbo.ComputerUsingHistories", "UserId", "dbo.ApplicationUsers");
