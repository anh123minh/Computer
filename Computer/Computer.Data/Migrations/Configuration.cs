...
namespace Computer.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Computer.Data.ComputerDbContext>
    {
        ...
        private void CreateProductCategorySample(Computer.Data.ComputerDbContext context)
        {
        ...
        private void CreateSize(Computer.Data.ComputerDbContext context)
        {
        ...
        private void CreateColor(Computer.Data.ComputerDbContext context)
        {
        ...
        private void CreateFooter(ComputerDbContext context)
        {
        ...
        private void CreateSlide(ComputerDbContext context)
        {
        ...
        private void CreatePage(ComputerDbContext context)
        {
        ...
        private void CreateContactDetail(ComputerDbContext context)
        {
            if (context.ContactDetails.Count() == 0)
            {
                try
                {
                    var contactDetail = new Computer.Model.Models.ContactDetail()
                    {
